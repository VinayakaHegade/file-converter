const PrivacyPolicy = () => {
    return (
      <section className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        <p>Effective Date: Tue 26 Dec 2023</p>
        <p>
          At Convio, we are committed to safeguarding your privacy. This Privacy
        ...
        <p>
          By using Convio, you agree to the practices outlined in this Privacy
